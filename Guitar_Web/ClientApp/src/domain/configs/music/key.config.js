...
export const keys = [
    ...
    new Key(new Tone(1), 'B'),
    new Key(new Tone(2), 'B'),
    new Key(new Tone(3), 'C'),
    new Key(new Tone(4), 'C'),
    new Key(new Tone(4), 'D'),
    new Key(new Tone(5), 'D'),
    new Key(new Tone(6), 'D'),
    new Key(new Tone(6), 'E'),
    new Key(new Tone(7), 'E'),
    new Key(new Tone(8), 'F'),
    new Key(new Tone(9), 'F'),
    new Key(new Tone(9), 'G'),
    new Key(new Tone(10), 'G'),
    new Key(new Tone(11), 'G'),
    new Key(new Tone(11), 'A'),
]
